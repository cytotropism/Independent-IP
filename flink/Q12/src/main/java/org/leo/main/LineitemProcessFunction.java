...
public class LineitemProcessFunction extends KeyedCoProcessFunction<Object, Payload, Payload, Payload> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        ValueStateDescriptor<Payload> alivePayloadDescriptor = new ValueStateDescriptor<Payload>(
                "LineitemProcessFunction" + "Alive Payload", Payload.class);
        ...
        ValueStateDescriptor<Set<Payload>> setValueStateDescriptor = new ValueStateDescriptor<>(
                "LineitemProcessFunction" + "Alive Set", typeInformation);
